...
import com.meta.portal.sdk.app.databinding.ActivityCameraBinding

private const val IMMERSIVE_FLAG_TIMEOUT = 500L

class CameraActivity : FeatureBaseActivity() {
    ...
    @StringRes
    override fun getFeatureInfoHeaderResId(): Int {
        return R.string.smart_camera_feature_info_header
    }

    @StringRes
    override fun getFeatureInfoTextResId(): Int {
