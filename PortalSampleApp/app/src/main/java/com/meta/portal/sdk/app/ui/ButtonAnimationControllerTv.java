...
public class ButtonAnimationControllerTv {
    ...
    public ButtonAnimationControllerTv(View modeButtons, View moveButtons, View zoomButtons, View doneButton) {
    ...
    public void startMoveButtonsFadeInAnimation() {
        ...
        mModeButtonsFadeOutAnimator = ObjectAnimator.ofFloat(mModeButtons, "alpha",
                0f);
        mModeButtonsFadeOutAnimator.setDuration(BUTTON_FADE_OUT_DURATION);
        mModeButtonsFadeOutAnimator.addListener(new AnimatorListenerAdapter() {
            @Override
            public void onAnimationEnd(Animator animation) {
                mMoveButtonsFadeInAnimator = ObjectAnimator.ofFloat(mMoveButtons, "alpha",
                        1.0f);
                mMoveButtonsFadeInAnimator.setDuration(BUTTON_FADE_IN_DURATION);
                mZoomButtonsFadeInAnimator = ObjectAnimator.ofFloat(mZoomButtons, "alpha",
                        1.0f);
                mZoomButtonsFadeInAnimator.setDuration(BUTTON_FADE_IN_DURATION);
                mDoneButtonFadeInAnimator = ObjectAnimator.ofFloat(mDoneButton, "alpha",
                        1.0f);
                mDoneButtonFadeInAnimator.setDuration(BUTTON_FADE_IN_DURATION);

                mMoveButtonsFadeInAnimatorSet = new AnimatorSet();

                mMoveButtonsFadeInAnimatorSet.playTogether(mMoveButtonsFadeInAnimator, 
                        mZoomButtonsFadeInAnimator, mDoneButtonFadeInAnimator);

                mMoveButtonsFadeInAnimatorSet.addListener(new AnimatorListenerAdapter() {
                    @Override
                    public void onAnimationEnd(Animator animation) {
    ...
    public void startModeButtonsFadeInAnimation() {
        ...
        mMoveButtonsFadeOutAnimator = ObjectAnimator.ofFloat(mMoveButtons, "alpha",
                0f);
        mMoveButtonsFadeOutAnimator.setDuration(BUTTON_FADE_IN_DURATION);
        mZoomButtonsFadeOutAnimator = ObjectAnimator.ofFloat(mZoomButtons, "alpha",
                0f);
        mZoomButtonsFadeOutAnimator.setDuration(BUTTON_FADE_IN_DURATION);
        mDoneButtonFadeOutAnimator = ObjectAnimator.ofFloat(mDoneButton, "alpha",
                0f);
        mDoneButtonFadeOutAnimator.setDuration(BUTTON_FADE_IN_DURATION);

        mMoveButtonsFadeOutAnimatorSet = new AnimatorSet();

        mMoveButtonsFadeOutAnimatorSet.playTogether(mMoveButtonsFadeOutAnimator,
                mZoomButtonsFadeOutAnimator, mDoneButtonFadeOutAnimator);

        mMoveButtonsFadeOutAnimatorSet.addListener(new AnimatorListenerAdapter() {
            @Override
            public void onAnimationEnd(Animator animation) {
                super.onAnimationEnd(animation);
                mModeButtonsFadeInAnimator = ObjectAnimator.ofFloat(mModeButtons, "alpha",
                        1.0f);
