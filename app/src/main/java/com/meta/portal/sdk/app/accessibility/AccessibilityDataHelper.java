...
//  }
  ...
  private void initFbnsData() {
    ...
    accessibilityDataLabels.setCardTitle("All screen elements have accessibility labels for screen readers");
    accessibilityDataLabels.setStep(1);
    accessibilityDataLabels.setInfoTitle("All screen elements have accessibility labels for screen readers");
    ...
    accessibilityDataColor.setCardTitle("All user interface elements conform to WCAG 2.1 color ratio requirements");
    accessibilityDataColor.setStep(2);
    accessibilityDataColor.setInfoTitle("All user interface elements conform to WCAG 2.1 color ratio requirements");
    ...
    accessibilityDataSpace.setCardTitle("All user interface elements contain touch targets with sufficient space");
    accessibilityDataSpace.setStep(3);
    accessibilityDataSpace.setInfoTitle("All user interface elements contain touch targets with sufficient space");
    ...
    accessibilityDataSettings.setCardTitle("Go to Settings > Accessibility and select each of the available settings for font size, contrast, color inversion and correction ensuring your application:\n" +
    ...
    accessibilityDataSettings.setInfoTitle("Go to Settings > Accessibility and select each of the available settings for font size, contrast, color inversion and correction ensuring your application:");
